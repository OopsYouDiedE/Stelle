...
const inputPath = process.argv[2] ?? "reference/legacy-src/artifacts/research_messages.json";
const outputPath = process.argv[3] ?? "reference/legacy-src/artifacts/research_messages_memory_notes.md";
