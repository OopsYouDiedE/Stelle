...
function createStelleChild(targetMode, options) {
  if (options.watch) {
    return {
      name: "stelle",
      ...tsxCommand(["watch", "reference/legacy-src/src/start.ts", targetMode]),
  ...
  return {
    name: "stelle",
    ...tsxCommand(["reference/legacy-src/src/start.ts", targetMode]),
    startKokoroAfter: targetMode === "runtime",
  };
}
...
function createKokoroChild() {
  return {
    name: "kokoro",
    command: pythonExe,
    args: [path.join(rootDir, "reference", "legacy-src", "scripts", "kokoro_tts_server.py")],
    process: undefined,
  };
}
...
function createBilibiliChild(options = {}) {
  return {
    name: "bilibili",
    ...tsxCommand([
      path.join(rootDir, "reference", "legacy-src", "scripts", "bilibili_danmaku_bridge.ts"),
