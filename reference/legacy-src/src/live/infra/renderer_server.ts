...
export class LiveRendererServer {
  ...
  private setupRoutes() {
    ...
    this.app.use("/samples", express.static(path.resolve("reference/legacy-src/assets/renderer/samples")));
    this.app.use("/models", express.static(path.resolve("reference/legacy-src/assets/renderer/models")));
    this.app.use("/vendor", express.static(path.resolve("reference/legacy-src/assets/renderer/vendor")));
